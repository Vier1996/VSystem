...
namespace VSystem.Server.SystemServer;

public interface ISystemServer : IDisposable
{
    public Task<ISystemServer> StartAsync();
    public Task<ISystemServer> StopAsync();
}
...
public class SystemServer : ISystemServer
{
    ...
    public async Task<ISystemServer> StartAsync()
    {
    ...
    public async Task<ISystemServer> StopAsync()
    {
        _isRunning = false;
